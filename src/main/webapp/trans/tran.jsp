...
<input type="radio" name="bank_account" value="전체거래내역" onclick='test(this.value);'checked>전체거래내역
<input type="radio" name="bank_account" value="입금내역" onclick="window.location.href='tran1.do'">입금내역
