...
<%-- 				class="mapView btn btn-primary" data-location="${acclist.location}" data-id="${acclist.trans_id}">
--%>
<!-- 전체 레이아웃 -->
    <div id="wrap">
            <!-- Content -->
		...
		class="mapView btn btn-primary" data-location="${acclist.location}" data-id="${acclist.trans_id}" onClick="javascript:popOpen();">
    ...
    <!-- //전체 레이아웃 -->
					...
					test="${acclist.trans_kind=='자동이체'}">자동이체</c:if>
					<c:if test="${acclist.trans_kind=='출금'}">출금</c:if></td>
					    </tbody>
	</c:forEach>
